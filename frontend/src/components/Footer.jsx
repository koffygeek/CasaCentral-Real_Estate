    ...
    <footer className="max-padd-container mb-4">
      <div className="max-padd-container bg-primary rounded-tr-3xl pt-12 xl:pt-20 pb-8">
        ...
        <p>
          ...
          doloremque expedita aspernatur voluptatem aperiam eveniet adipisci
          possimus esse vel velit, consectetur eaque omnis distinctio provident
          sed porro delectus deleniti quaerat?
        </p>
        ...
        <div className="flex justify-between flex-wrap gap-x-2 gap-y-8">
          <div className="max-w-sm">
            ...
            <p className="py-4">
              ...
              nobis assumenda accusamus voluptatem illo ab et odit doloremque
              illum maxime incidunt, debitis ad veniam non dolorum! Quidem quasi
              excepturi nesciunt!
            </p>
